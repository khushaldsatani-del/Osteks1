...
export default {
  ...
  normLibrary: {
    title: "Norm Library",
    subtitle: "Every coating norm the app recognises, with its thickness and test requirements",
    searchPlaceholder: "Search a norm, e.g. GS 90011 LA SW 3 or VW 13750 Ofl-s621",
    customer: "Customer",
    allCustomers: "All customers",
    resolving: "Checking how the app reads this…",
    resolvedAs: "The app reads this as",
    notResolved: "The app does not recognise this norm - Specification and Schichtdicke would stay empty.",
    schichtdicke: "Schichtdicke",
    testReportCycles: "Test report cycles",
    cyclesDefault: "default (60)",
    loading: "Loading norms…",
    error: "Could not load the norm list. Is the backend running?",
    count: "{count} norms",
    colNorm: "Norm",
    colMeaning: "Meaning",
    colThickness: "Coating thickness",
    colTests: "Test requirements",
    colCycles: "Test report cycles",
    showMore: "{count} more",
    showLess: "Show less",
    coverage_full: "full data",
    coverage_partial: "partial",
    coverage_meaning: "meaning only",
  },
  ...
  specificationModal: {
    ...
    factCorrosionTestCycles: "Cyclic Corrosion Test (customer method)",
    factCorrosionTestWeeks: "Corrosion Test Duration",
    factSaltSpray: "Salt Spray Test (NSS)",
    factCass: "CASS Test",
    factCrossCut: "Cross-cut Adhesion",
    factStoneChip: "Stone Chip Resistance",
    factWeathering: "Weathering",
    factThicknessNote: "Coating Thickness (note)",
